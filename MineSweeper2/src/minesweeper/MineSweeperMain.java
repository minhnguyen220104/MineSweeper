...
public class MineSweeperMain extends JFrame {
   ...
   JMenuItem help, about, initldr, demomode;
   ...
   public class TopBar extends JPanel{
	   ...
	   Icon reset = new ImageIcon("src/resources/reset.png");
	   Icon pause = new ImageIcon("src/resources/pause.PNG");
	   Icon resume = new ImageIcon("src/resources/resume.PNG");
   ...
   public class LoginBar extends JPanel{
	   JTextField playerSet = new JTextField("");
